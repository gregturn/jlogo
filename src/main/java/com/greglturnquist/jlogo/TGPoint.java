 ...
 * spaces are represented in Algebra.  Likewise, TGPoints have appoximated
 * real number coordinates.  TGPoints may or may not be visible based upon
 * the current size of the graphics canvas window of TG. Methods are provided
 * to map the point's coordinates from TurtleSpace to an Image's x and y
 * indicies.
 * <p>
